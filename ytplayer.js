      ...
      if(json.error){
        ...
        for (var i = 0; i < json.data.items.length; i++) {
          ...
          if(this.cfg.layout == 'thumbnails'){
            ...
            //this.cfg.layout = full
            /*li.innerHTML = '<table cellspacing="0" cellpadding="0" border="0"><tr><td valign="top" rowspan="2" style="width: 150px"></td><td valign="top"><h3>'+entry.title+'</h3><span>'+this.formatDescription(entry.description)+'</span></td><td valign="top" style="width: 150px" class="meta"><div>From: <a href="http://www.youtube.com/profile?user='+entry.uploader+'">'+entry.uploader+'</a></div><div>Views: '+entry.viewCount+'</div><div>'+this.formatRating(entry.rating,entry.ratingCount)+' ratings</div>Time: '+this.formatDuration(entry.duration)+'</td></tr></table>';*/
            li.innerHTML = '<table cellspacing="0" cellpadding="0" border="0"><tr><td valign="top" rowspan="1" style="width: 150px"></td><td valign="top"><h5>'+entry.title+'</h5><span>'+this.formatDuration(entry.duration)+'</span></td></tr></table>';
            //li.innerHTML = '<span>'+entry.title+'</span>';
